...
const testimonials: Testimonial[] = [
  {
    name: "Deepa S., 39",
    condition: "Teacher",
    text: "“My frozen shoulder made daily tasks painful. After 3 weeks of therapy, I can lift my arm freely again!”",
  },
  {
    name: "Aravind R., 45",
    condition: "IT Employee",
    text: "“Neck pain from long desk hours was unbearable. Ayush Ortho's OMT + Varma therapy gave me real relief.”",
  },
  {
    name: "Meenakshi, 52",
    condition: "Homemaker",
    text: "“I was advised surgery for cervical spondylosis, but Ayush Ortho's non-surgical plan worked wonders.”",
  },
];

export default function Neckreviews() {
