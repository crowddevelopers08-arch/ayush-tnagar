...
const testimonials: Testimonial[] = [
  {
    ...
    text: "“I couldn’t climb stairs without support. After 14 days of Varma + Janu Vasti, my pain reduced drastically. I can walk freely again.”",
  },
  {
    name: "Mr. Ramesh, 38",
    condition: "Ligament Tear",
    text: "“After a ligament injury, I feared surgery. With Navara Kizhi & therapy sessions, my knee regained strength in 3 weeks. No surgery needed.”",
  },
  {
    name: "Mrs. Shanthi, 62",
    condition: "Chronic Knee Pain",
    text: "“I was advised surgery, but Ayush Ortho’s 21-day non-surgical plan gave me relief. I can walk longer distances again and feel younger.”",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className={`text-2xl text-center sm:text-3xl lg:text-4xl pb-4 max-[470px]:pb-0 sm:pb-5 lg:pb-6 font-bold text-gray-900 mb-4 sm:mb-6 transition-all duration-1000 ${
          ...
          Patient <span className="text-[#e13e20] font-bold">Success</span> Stories
        </h2>
