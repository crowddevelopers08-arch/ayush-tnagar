...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="tnagar flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-[#f7f6f1] py-8 sm:py-12">
        <section className="mx-auto w-full max-w-4xl rounded-lg bg-white px-4 py-8 leading-relaxed text-gray-800 shadow-md sm:px-6 md:px-8">
          ...
          <div className="mb-6 flex justify-center">
            <div className="h-1 w-16 rounded-full bg-[#e13e20]"></div>
          </div>

          {/* Title */}
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-2xl font-bold text-black sm:text-3xl md:text-4xl">Privacy Policy</h1>
            <p className="text-gray-500">Ayush Ortho — T. Nagar, Chennai</p>
          </div>
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <div className="rounded-full bg-[#e13e20] p-2">
                <Eye className="h-5 w-5 text-white" />
              </div>
              <h2 className="text-lg font-semibold text-[#e13e20] sm:text-xl">1. Information We Collect</h2>
            </div>
            ...
            <ul className="mb-6 grid grid-cols-1 gap-2 text-gray-800 sm:grid-cols-2">
              {[
                ...
                <li key={item} className="flex items-center gap-2">
                  <div className="h-2 w-2 flex-shrink-0 rounded-full bg-[#e13e20]"></div>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-[#e13e20] sm:text-xl">2. How We Use Your Information</h2>
            </div>
            ...
            <ul className="mb-6 space-y-3 text-gray-800">
              {[
                ...
                "Schedule and manage your appointments at our T. Nagar clinic.",
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-[#e13e20] sm:text-xl">3. Data Protection &amp; Security</h2>
            </div>
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-[#e13e20] sm:text-xl">4. Your Rights &amp; Choices</h2>
            </div>
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-[#e13e20] sm:text-xl">5. Contact Us</h2>
            </div>
            ...
            <div className="mb-6 rounded-lg bg-gray-50 p-4 sm:p-5">
              ...
              <div className="mb-3 flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  23A, N Boag Rd, Drivers Colony, T. Nagar, Chennai, Greater Chennai, Tamil Nadu 600017
                </span>
              </div>
